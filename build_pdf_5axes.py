"""모바일 게임 산업 5대 축 PDF 빌더 — 기존 빌더와 동일 양식."""
import json
import re
from pathlib import Path
from fpdf import FPDF

BOOK_DIR = Path('C:/Users/cyon1/OneDrive/Desktop/Autobook/02_Books/모바일 게임 산업 5대 축')
PAGES_DIR = BOOK_DIR / 'wikidocs' / 'pages'
OUT = Path('C:/Users/cyon1/OneDrive/Desktop/Autobook/모바일 게임 산업 5대 축.pdf')

with open(BOOK_DIR / 'curriculum.json', encoding='utf-8') as f:
    cur = json.load(f)

TITLE = '모바일 게임 산업 5대 축'
SUBTITLE = 'Player Intelligence부터 LiveOps까지 한 사이클로 묶이는 자리'
KEYWORDS = 'LiveOps · 하이브리드캐주얼 · SKAN · 생성형 AI · Player Intelligence'
YEAR = '2026'
