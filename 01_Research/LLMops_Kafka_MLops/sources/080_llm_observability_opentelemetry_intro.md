...
Note: The LLM Working Group has recommended on capturing these details on events instead of span attributes because many backend systems can struggle with those often large payloads.
...
3. In the settings, enter your Jaeger URL, for example, `http://<your_jaeger_host>`, along with any other necessary details.
4. Select Save & Test.
